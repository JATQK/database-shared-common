...
@Repository
public interface GithubRepositoryOrderStatisticRepository extends JpaRepository<GithubRepositoryOrderStatisticEntity, Long> {
    ...
    List<GithubRepositoryOrderStatisticEntity> findAllByGithubRepositoryOrderIdAndStatisticType(Long githubRepositoryOrderId,
            String statisticType);

    List<GithubRepositoryOrderStatisticEntity> findAllByTaskSessionId(String taskSessionId);

    Optional<GithubRepositoryOrderStatisticEntity> findTopByGithubRepositoryOrderIdAndStatisticTypeOrderByStatisticVersionDesc(Long orderId, String statisticType);
    ...
    List<GithubRepositoryOrderStatisticEntity> findByGithubRepositoryOrderIdWithRdfData(@Param("orderId") Long orderId);

    @Query("SELECT s FROM GithubRepositoryOrderStatisticEntity s WHERE s.statisticType = :statisticType AND s.rdfBlob IS NOT NULL")
    List<GithubRepositoryOrderStatisticEntity> findByStatisticTypeWithRdfData(@Param("statisticType") String statisticType);
